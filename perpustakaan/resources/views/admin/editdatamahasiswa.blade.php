                        ...
                        {!! Form::open(['url'=>route('submiteditdatamahasiswa', $Mahasiswa->id),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                           <div class="col-md-12">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="nim" value="{{$Mahasiswa->nim}}" required>
                              <span class="bar"></span>
                              <label>NIM</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="nama" value="{{$Mahasiswa->nama}}" required>
                              <span class="bar"></span>
                              <label>Nama</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="tempat_lahir" value="{{$Mahasiswa->tempat_lahir}}" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <br>
                              <br>
                              <input type="date" class="form-text"  name="tanggal_lahir" value="{{$Mahasiswa->tanggal_lahir}}" required>
                              <span class="bar"></span>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            ...
                            <label class="radio">
                            <input id="radio1" type="radio" name="jenis_kelamin" value="Laki-laki"
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="no_telepon" value="{{$Mahasiswa->no_telepon}}" required>
                              <span class="bar"></span>
                              <label>No. telepon</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="alamat" value="{{$Mahasiswa->alamat}}" required>
                              <span class="bar"></span>
                              <label>Alamat</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="email" value="{{$Mahasiswa->email }}" required>
                              <span class="bar"></span>
                              <label>Email</label>
                            </div>
                           </div>
