			  ...
			  <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Data <span class="fa-angle-right fa"></span> Data Supplier <span class="fa-angle-right fa"></span> Tambah
                        </p>
                    </div>
                  </div>
              </div>
                  ...
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                      	{!!Form::open(['url'=>route('submittambahdatasupplier'),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}

                          <div class="col-md-12">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="id_supplier" required>
                              <span class="bar"></span>
